...
- **版本**：v0.3
- **日期**：2026-07-25
- **关联 ADR**：`docs/02-architecture/adr/`（含 ADR-0004 两段式预审、ADR-0005 讲清度与公屏待回放）

---

## 1. 上下文（C4 精简）

本系统是**本地 CLI 编排的课评流水线**：消费授课音视频，产出私密 Markdown 报告。业务标准来自上游文档仓；本仓负责执行与提示词版本。适用课堂默认以**公屏（桌面共享）**授课（PPT / 笔记软件 / IDE），不以黑板板书为默认媒介。
...
| v0.4 | 2026-07-25 | 默认授课媒介改为公屏；关联 ADR-0005    |
